...
public class Cluster {
    ...
    public Cluster( ArrayList<Encuesta_Respondida> lista_respuestas) {
        ...
        this.lista_encuesta_respondida = lista_respuestas;      // TODO nombre único de cluster
    ...
    public void setId_cluster(int num_cluster_siguiente) {
...
//    }
    ...
    public void Calcular_Centroide(){
        ...
        ArrayList<Cluster> grupo_cluster;
...
//        int cantidad_preguntas= e.getLlista_preguntes().size();
    ...
    /**
     * @dados 2 clusters la funcion devuelve un nuevo cluster, juntando i recalculando el centroide con los  2 clusters dados,
     */
    public Cluster Combina_clusters(Cluster c1, Cluster c2){
        Cluster resultado = new Cluster();
        resultado.setLista_encuesta_respondida(c1.getLista_encuesta_respondida());
        resultado.agregar_enquestas_respondidas(c2.getLista_encuesta_respondida());
        return resultado;
    }

    public void agregar_enquestas_respondidas(ArrayList<Encuesta_Respondida> lista_encuesta_respondida1) {
        lista_encuesta_respondida.addAll(lista_encuesta_respondida1);
    }
